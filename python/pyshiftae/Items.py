...
class Item:
    ...
    def has_proxy(self) -> bool:
        return (
            PyFx.ItemSuite().GetItemFlags(self.item) & PyFx.ItemFlag.HAS_PROXY
        )

    @property
    def using_proxy(self) -> bool:
        return (
            PyFx.ItemSuite().GetItemFlags(self.item) & PyFx.ItemFlag.USING_PROXY
        )
    ...
    def missing_proxy(self) -> bool:
        return (
            PyFx.ItemSuite().GetItemFlags(self.item)
            & PyFx.ItemFlag.MISSING_PROXY
        )

    @property
    def has_video(self) -> bool:
        return (
            PyFx.ItemSuite().GetItemFlags(self.item) & PyFx.ItemFlag.HAS_VIDEO
        )

    @property
    def has_audio(self) -> bool:
        return (
            PyFx.ItemSuite().GetItemFlags(self.item) & PyFx.ItemFlag.HAS_AUDIO
        )
    ...
    def has_active_audio(self) -> bool:
        return (
            PyFx.ItemSuite().GetItemFlags(self.item)
            & PyFx.ItemFlag.HAS_ACTIVE_AUDIO
        )
